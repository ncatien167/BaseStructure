...
struct APIController {
    ...
    static func request<T: Decodable>(responseType: T.Type, manager: APIManager, params: Parameters? = nil, completion: @escaping ResponseBlock<T>){
        ...
        AF.request(manager.url, method: manager.method, parameters: params, encoding: manager.encoding, headers: manager.header).validate().responseData { (responseData) in
...
//            }
//            } as! RequestInterceptor as! RequestInterceptor
//    }
